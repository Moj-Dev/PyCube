...
class cubeSession():
    ...
    def get(self, page, params):
        ...
        try:
            ...
            #r = self.s.get("http://192.72.1.1/liveRTSP/v2", params = params, timeout=HTTP_TIMEOUT)
            pretty_session(r)
...
class cubeCapture(QtCore.QThread):
    def __init__(self):
        ...
        self.rtsp = cv2.VideoCapture("rtsp://192.72.1.1/liveRTSP/v2")
...
class CubeWifi():
    ...
    cube_conn = {u'802-11-wireless': {
     ...
     u'802-11-wireless-security': {u'auth-alg': u'open',
                                   ...
                                   u'proto': [],
                                   u'psk': u'1234567890'},
     u'connection': {u'id': u'CUBE+8LGKHHRC',
